...
// Preview audience size + sample (safe; for the UI before a broadcast).
...
// Resolve to a recipient list the broadcast engine consumes (phones only; opted-out excluded).
...
// Evaluate an ad-hoc segment definition without storing it.
