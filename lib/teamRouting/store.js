// lib/teamRouting/store.js — Atomic JSON store for agents + assignments + queue. Never throws.
...
function load() {
 ...
 // assignments: conversationId -> { agentId, at, skill }
 d.assignments = d.assignments && typeof d.assignments === 'object' ? d.assignments : {};
 d.queue = Array.isArray(d.queue) ? d.queue : [];
 if (typeof d.rrCursor !== 'number') d.rrCursor = 0;
 return d;
}
