// lib/templateMarketplace/adapters/businessSetupAdapter.js — Safe adapter for Business Setup Wizard.
...
'use strict';
let available=false;
try { require.resolve('../../../lib/unifiedSetup'); available=true; } catch (_e) { available=false; }
const MODULE='unifiedSetup';
