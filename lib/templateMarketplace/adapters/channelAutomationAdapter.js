// lib/templateMarketplace/adapters/channelAutomationAdapter.js — Safe adapter for Channel Automation.
...
'use strict';
let available=false;
try { require.resolve('../../../lib/channelAutomationCenter.js'); available=true; } catch (_e) { available=false; }
const MODULE='channelAutomation';
