// lib/templateMarketplace/adapters/flowStudioAdapter.js — Safe adapter for Flow Studio.
...
'use strict';
let available=false;
try { require.resolve('../../../lib/flowStudio'); available=true; } catch (_e) { available=false; }
const MODULE='flowStudio';
