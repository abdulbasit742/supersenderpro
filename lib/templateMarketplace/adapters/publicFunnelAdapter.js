// lib/templateMarketplace/adapters/publicFunnelAdapter.js — Safe adapter for Public SaaS Funnel.
...
'use strict';
let available=false;
try { require.resolve('../../../lib/publicSaasFunnel'); available=true; } catch (_e) { available=false; }
const MODULE='publicSaasFunnel';
