// lib/templateMarketplace/adapters/ownerCommandAdapter.js — Safe adapter for Owner Command.
...
'use strict';
let available=false;
try { require.resolve('../../../lib/ownerBriefing'); available=true; } catch (_e) { available=false; }
const MODULE='ownerCommand';
