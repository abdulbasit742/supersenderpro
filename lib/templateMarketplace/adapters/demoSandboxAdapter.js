// lib/templateMarketplace/adapters/demoSandboxAdapter.js — Safe adapter for Demo Sandbox.
...
'use strict';
let available=false;
try { require.resolve('../../../lib/demoSandbox'); available=true; } catch (_e) { available=false; }
