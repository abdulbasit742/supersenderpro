// lib/templateMarketplace/adapters/playbookAdapter.js — Safe adapter for Playbook Builder.
...
'use strict';
let available=false;
try { require.resolve('../../../lib/playbookBuilder'); available=true; } catch (_e) { available=false; }
const MODULE='playbookBuilder';
