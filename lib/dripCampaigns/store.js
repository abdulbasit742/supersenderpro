// lib/dripCampaigns/store.js — Atomic JSON store for drip campaigns. Never throws on read.
...
function load() {
 ...
 d.enrollments = Array.isArray(d.enrollments) ? d.enrollments : [];
 d.sends = Array.isArray(d.sends) ? d.sends : [];
 return d;
}
