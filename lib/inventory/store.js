// lib/inventory/store.js — Atomic JSON store for products + reservations + ledger. Never throws.
...
function load() {
 ...
 // reservations: { [reservationId]: { sku, qty, orderId, at, status } }
 d.reservations = d.reservations && typeof d.reservations === 'object' ? d.reservations : {};
