// lib/booking/store.js — Atomic JSON store for services + availability + appointments. Never
// throws on read. Writes atomically via tmp+rename. Creates the data dir on demand.
