'use strict';
/**
 * lib/conversationalSupport/store.js - tenant-scoped JSON persistence with an mtime-based read
 * cache. Mirrors the repo's fs+JSON convention but avoids per-request disk reads (Phase 3 goal).
 */
const fs = require('fs');
