 ...
 function preview(limit) {
   ...
   if (!records) records = [
     { at: '2026-06-20T09:00:00Z', actor: 'C*** ', action: 'portal_status_viewed_preview', area: 'invoice' },
     { at: '2026-06-20T09:02:00Z', actor: 'C*** ', action: 'support_request_preview', area: 'ticket' },
     { at: '2026-06-20T09:05:00Z', actor: 'system', action: 'message_draft_preview', area: 'message' },
   ];
