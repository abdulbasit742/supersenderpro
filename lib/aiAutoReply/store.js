// lib/aiAutoReply/store.js — Atomic JSON store for the AI auto-reply department.
...
function load() {
 ...
 d.cooldowns = d.cooldowns && typeof d.cooldowns === 'object' ? d.cooldowns : {};
 return d;
}
