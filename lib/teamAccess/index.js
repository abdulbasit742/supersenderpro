...
const seatLimitMonitor=require('./seatLimitMonitor');
const accessHistory=require('./accessHistory');
const bulkAccess=require('./bulkAccess');
...
function dashboard(){
  ...
  const seatMonitor=seatLimitMonitor.summary();
  ...
  return {
    overview:{
      ...
      seatLimitWarnings:seatWarnings, seatsNear:seatMonitor.near, seatsExceeded:seatMonitor.exceeded,
...
module.exports={
  ...
  seatLimits, seatUsage, invites, riskyActionGate, seatLimitMonitor, accessHistory, bulkAccess,
