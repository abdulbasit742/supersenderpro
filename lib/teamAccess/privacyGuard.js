// lib/teamAccess/privacyGuard.js — Redaction + leak detection for Team Access outputs.
// Blocks API keys, tokens, invite tokens, full phone numbers and raw emails from leaving the module.
'use strict';
const PATTERNS=[
...
const SECRET_KEYS=/(token|secret|password|apikey|api_key|authorization|cookie|credential|privatekey|invitetoken|invite_token)/i;
function redact(obj){
...
// Mask tenant/reseller/member identifiers so private ids are never fully exposed in responses.
