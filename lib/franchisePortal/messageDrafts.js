// lib/franchisePortal/messageDrafts.js — Safe franchise message draft previews. Never sends (WhatsApp/email/SMS).
'use strict';
...
function recipientMasked(input) {
  ...
  return maskPhone(input.recipient || (franchise && franchise.phone) || '');
}
