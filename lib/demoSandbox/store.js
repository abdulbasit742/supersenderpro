// lib/demoSandbox/store.js — Safe JSON store for the Demo Sandbox (atomic, fault-tolerant).
// Demo-only persistence. Never stores real PII, secrets, or live references.
const fs = require('fs');
