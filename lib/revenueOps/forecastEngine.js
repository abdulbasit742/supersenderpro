...
// Deterministic weighted pipeline value (raw number for internal metrics; never returned unbanded by APIs).
...
module.exports = { forecast, weightedPipelineValue, BAND_MID };
