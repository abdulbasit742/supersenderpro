...
const COMMANDS = ['!marketstatus', '!topsellers', '!topbuyers', '!sku', '!price', '!stock', '!demand', '!opportunities', '!seller', '!buyer', '!marketdigest', '!riskposts', '!trending', '!heatmap', '!bundles', '!marketsummary', '!stockrisk', '!gap'];
