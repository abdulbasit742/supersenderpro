...
// Public sender used by orderNotify + tracking. Dry-run safe.
...
module.exports = { bindSender, send, processOrder, handleBuyerReply, adminMsg, buyerCodMsg, isCOD, enabled };
