// lib/alertCenter/store.js — Atomic JSON store for alert rules + feed. Never throws on read.
...
function load() {
 ...
 d.feed = Array.isArray(d.feed) ? d.feed : [];
 d.throttle = d.throttle && typeof d.throttle === 'object' ? d.throttle : {};
 return d;
}
