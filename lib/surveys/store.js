// lib/surveys/store.js — Atomic JSON store for surveys + sends + responses. Never throws on read.
...
function load() {
 ...
 // open asks keyed by contact token -> { surveyId, sentAt } (the most recent outstanding ask)
 d.openAsks = d.openAsks && typeof d.openAsks === 'object' ? d.openAsks : {};
 d.responses = Array.isArray(d.responses) ? d.responses : [];
 return d;
}
