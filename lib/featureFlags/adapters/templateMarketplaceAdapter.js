// lib/featureFlags/adapters/templateMarketplaceAdapter.js — Safe adapter for Template Marketplace.
...
'use strict';
let available=false;
try { require.resolve('../../../lib/templateMarketplace'); available=true; } catch (_e) { available=false; }
const MODULE='templateMarketplace';
