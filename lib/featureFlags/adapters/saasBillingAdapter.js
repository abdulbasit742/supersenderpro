// lib/featureFlags/adapters/saasBillingAdapter.js — Safe adapter for SaaS Billing.
...
'use strict';
let available=false;
try { require.resolve('../../../lib/saasBilling'); available=true; } catch (_e) { available=false; }
const MODULE='saasBilling';
