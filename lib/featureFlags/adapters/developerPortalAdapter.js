// lib/featureFlags/adapters/developerPortalAdapter.js — Safe adapter for Developer Portal.
...
'use strict';
let available=false;
try { require.resolve('../../../lib/developerPortal'); available=true; } catch (_e) { available=false; }
const MODULE='developerPortal';
