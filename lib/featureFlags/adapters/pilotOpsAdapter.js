// lib/featureFlags/adapters/pilotOpsAdapter.js — Safe adapter for Pilot Ops.
...
'use strict';
let available=false;
try { require.resolve('../../../lib/pilotOps'); available=true; } catch (_e) { available=false; }
const MODULE='pilotOps';
