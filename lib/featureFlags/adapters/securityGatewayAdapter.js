// lib/featureFlags/adapters/securityGatewayAdapter.js — Safe adapter for Security Gateway.
...
'use strict';
let available=false;
try { require.resolve('../../../lib/securityGateway'); available=true; } catch (_e) { available=false; }
const MODULE='securityGateway';
