// lib/featureFlags/adapters/tenantPortalAdapter.js — Safe adapter for Tenant Portal.
...
'use strict';
let available=false;
try { require.resolve('../../../lib/tenantPortal'); available=true; } catch (_e) { available=false; }
const MODULE='tenantPortal';
