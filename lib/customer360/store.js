// lib/customer360/store.js — Atomic JSON store for the customer-360 timeline. Never throws on read.
...
function load() {
 ...
 // timelines: { [contactToken]: [ { id, type, at, meta } ] }
 d.timelines = d.timelines && typeof d.timelines === 'object' ? d.timelines : {};
 return d;
}
