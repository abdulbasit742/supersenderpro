...
try { fs.mkdirSync(ARTIFACTS, { recursive: true }); fs.writeFileSync(path.join(ARTIFACTS, 'shared_inbox_check.json'), JSON.stringify(report, null, 2)); } catch (e) {}
console.log('scripts/shared-inbox-check.js: ' + pass + ' pass, ' + fail + ' fail, ' + warn + ' warn');
