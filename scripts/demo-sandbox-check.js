...
const files = [
  ...
  "lib/demoSandbox/tourRegistry.js",
  "routes/demoSandboxRoutes.js",
  "public/demo-sandbox.html"
];
...
try { fs.mkdirSync(ARTIFACTS, { recursive: true }); fs.writeFileSync(path.join(ARTIFACTS, 'demo_sandbox_check.json'), JSON.stringify(report, null, 2)); } catch (e) {}
console.log('scripts/demo-sandbox-check.js: ' + pass + ' pass, ' + fail + ' fail, ' + warn + ' warn');
