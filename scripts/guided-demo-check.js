...
const files = [
  ...
  "lib/guidedDemo/demoJourneyRegistry.js",
  "lib/guidedDemo/demoStepRunner.js",
  "routes/guidedDemoRoutes.js",
  "public/guided-demo.html"
];
...
try { fs.mkdirSync(ARTIFACTS, { recursive: true }); fs.writeFileSync(path.join(ARTIFACTS, 'guided_demo_check.json'), JSON.stringify(report, null, 2)); } catch (e) {}
console.log('scripts/guided-demo-check.js: ' + pass + ' pass, ' + fail + ' fail, ' + warn + ' warn');
